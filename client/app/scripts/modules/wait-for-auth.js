...
.service('waitForAuth', function($rootScope, $q, $timeout) {
  ...
  function loginStatusChange(err) {
    if ($rootScope.auth) {
  ...
  subs.push($rootScope.$on('$firebaseSimpleLogin:login', loginStatusChange));
  subs.push($rootScope.$on('$firebaseSimpleLogin:logout', loginStatusChange));
  subs.push($rootScope.$on('$firebaseSimpleLogin:error', loginStatusChange));
